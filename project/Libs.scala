...
object Libs {
  ...
  lazy val stdLibs = Seq(
    "com.lihaoyi"   %% "pprint"           % Version.pprint, // .cross(CrossVersion.for3Use2_13),
  ...
  lazy val kittens = Seq("org.typelevel" %% "kittens" % Version.kittens)
  lazy val fs2     = Seq(
    "co.fs2" %% "fs2-core" % Version.fs2, // CE 3
    "co.fs2" %% "fs2-io"   % Version.fs2, //

    "org.gnieh" %% "fs2-data-json-circe"  % Version.fs2Data,
    "org.gnieh" %% "fs2-data-csv"         % Version.fs2Data,
    "org.gnieh" %% "fs2-data-csv-generic" % Version.fs2Data,
...
//    "com.tersesystems.logback"     % "logback-tracing"           % "1.0.3",
//    "com.tersesystems.logback"     % "logback-uniqueid-appender" % "1.0.3",
//    "com.tersesystems.logback"     % "logback-honeycomb-client"  % "1.0.3",
//    "com.tersesystems.logback"     % "logback-sigar"             % "1.0.3"
...
//  )
  ...
  val comcastNetworks = Seq("com.comcast" %% "ip4s-core" % Version.comcastNetworks)

  // Scala 3 Chimney
  val ducktape = Seq("io.github.arainko" %% "ducktape" % Version.ducktape)
